...
const mockUserData: GetUserByIdResponse['data'] = {
  id: 109,
  birthDate: "1996-11-24T00:00:00Z",
  bornPlace: 'Marand',
  details: 'chichi?',
  doesExercise: false,
  education: {
  ...
  profileImage: 'https://s3.lexoya.com/longbio-gca/profiles/170d1859-945e-47b0-828b-1c9d552d1dc7.jpg',
  skills: ['Painting', 'Cultural Travel', 'Dancing', 'singing'],
  travelStyle: ['Backpacking', 'Adventure Travel', 'Luxury Travel'],
  username: 'mehdii',
  visitedCountries: ['Belarus', 'Belgium'],
  weight: 48,
}
