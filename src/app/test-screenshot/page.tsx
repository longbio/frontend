...
import ShareScreenshot from '../bio/components/ShareScreenshot'
  ...
  return (
    <div className="bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div
          id="bio-content"
          className="flex flex-col justify-center items-center w-full h-screen bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden"
        >
          {/* Main Content */}
